...
func TestServiceCatalogCoverage(t *testing.T) {
	...
	if services[0].Protocol.Source.Qualifier != "SessionControl" || services[0].Request.Parameters[1].NumericValue == nil || *services[0].Request.Parameters[1].NumericValue != 3 || services[0].Transitions.RawExpression == nil || *services[0].Transitions.RawExpression != "(1,1)" || services[0].Transitions.Err != nil {
