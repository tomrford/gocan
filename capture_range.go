...
// WriteRecordsSince.
//
// End must be a cursor retained by this Capture. A stale cursor, a cursor from
// another Capture, or an end that does not follow start writes no records and
// returns start.
...
//
// End must be a cursor retained by this Capture. A stale cursor, a cursor from
// another Capture, or an end that does not follow start produces an empty
// result. Records appended after end are never included.
