// Package recorder writes capture records as they arrive.
//
// Task hands records to any RecordWriter and reports that handoff cursor.
// Logger requires a flushing Writer and reports a committed cursor after Flush.
package recorder
...
// not durable storage. Use Logger when the prune cursor must wait for Flush.
//
