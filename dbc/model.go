...
// signals use normal rounding. Scaled integer signals use float64 arithmetic
// and round to the nearest raw value; native Go integers must first convert
// to float64 exactly, while JSON numbers use normal float64 rounding.
